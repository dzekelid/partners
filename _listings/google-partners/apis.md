...
description: Google Partners is Googles program for advertising agencies, digital
  ...
  leads with them, and also audits the usage of clients.nbsp;
...
created: "2018-02-25"
modified: "2018-02-25"
url: https://raw.githubusercontent.com/streamdata-gallery/partners/master/_listings/google-partners/apis.yaml
...
- name: Google Partners API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/partners/master/_listings/google-partners/v2-users-userid-companyrelation-put.md
x-common:
- type: x-website
